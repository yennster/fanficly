...
An **Android port** (Kotlin + Jetpack Compose, OkHttp + Jsoup, Room) lives in [`android/`](android), mirroring the same on-device, no-trackers architecture. See [`android/README.md`](android/README.md) for the build and the iOS↔Android mapping, and [`docs/ANDROID_PUBLISHING.md`](docs/ANDROID_PUBLISHING.md) for Play Store publishing.
